...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        String result = "None";
        if((grid[0][0]=='x'&&grid[0][0]==grid[0][1]&&grid[0][0]==grid[0][2])||
                (grid[1][0]=='x'&&grid[1][0]==grid[1][1]&&grid[1][0]==grid[1][2])||
                (grid[2][0]=='x'&&grid[2][0]==grid[2][1]&&grid[2][0]==grid[2][2])||
                (grid[0][0]=='x'&&grid[0][0]==grid[1][0]&&grid[0][0]==grid[2][0])||
        ...
        else if((grid[0][0]=='o'&&grid[0][0]==grid[0][1]&&grid[0][0]==grid[0][2])||
                (grid[1][0]=='o'&&grid[1][0]==grid[1][1]&&grid[1][0]==grid[1][2])||
                (grid[2][0]=='o'&&grid[2][0]==grid[2][1]&&grid[2][0]==grid[2][2])||
                (grid[0][0]=='o'&&grid[0][0]==grid[1][0]&&grid[0][0]==grid[2][0])||
